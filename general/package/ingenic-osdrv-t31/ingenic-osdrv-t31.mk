...
define INGENIC_OSDRV_T31_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 755 -t $(TARGET_DIR)/usr/bin $(INGENIC_OSDRV_T31_PKGDIR)/files/script/ingenic_usb_eth_up
	$(INSTALL) -m 755 -t $(TARGET_DIR)/usr/bin $(INGENIC_OSDRV_T31_PKGDIR)/files/script/ingenic_usb
